...
public class TxTest01 {
	...
	@Test
	public void Test3() {
		String sql = "Insert into employee(emp_name,salary) values(:employeedName,:salary)";
		Employee employee = new Employee("haha", 998.98);
		SqlParameterSource psource = new BeanPropertySqlParameterSource(employee);
		int update = nameJdbcTemplate.update(sql, psource);
		System.out.println("更新，影响员工数：" + update);
	}
	...
	@Test
	public void Test4() {
		Employee employee = new Employee("xiangrini", 1314.20);
		int saveEmployee = employeeDao.saveEmployee(employee);
		System.out.println("插入成功，影响行数：" + saveEmployee);
	}
}
