...
public class EmployeeDaoTest {
	...
	public void testAddEmployeeByAll() {
		int addEmployee = employeeDao.addEmployee("u-001", "张三",new Date(), "zhangsan@qq.com", 1, "p-001");
		System.out.println(addEmployee);
	}

	@Test
	public void testAddEmployeeByAllandDepartment() {
		int addEmployee = employeeDao.addEmployee("u-002", "李四",new Date(), "李四@qq.com", 1,
	...
	public void testSelectEmployee() {
		Employee selectEmployee = employeeDao.SelectEmployee("u-001");
		Date birthday = selectEmployee.getBirthday();
		System.out.println(selectEmployee);
		System.out.println(utils.dateFormat(birthday));
	}	
